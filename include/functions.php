...
function obtenerHoraDesdeFecha($fecha_completa) {
  // Crea un objeto DateTime a partir de la cadena de fecha y hora
  $fecha_objeto = new DateTime($fecha_completa);

  // Formatea la fecha para mostrar solo la hora en formato de 12 horas
  $hora = $fecha_objeto->format('h:i a');
